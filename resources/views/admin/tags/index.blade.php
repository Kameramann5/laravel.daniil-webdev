    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ admin_route('tags.create')  }}" class="btn btn-primary mb-3">Добавить тег</a>
                    @if (count($tags))
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{{$tag->slug}}</td>
                            <td>
                                <a href="{{admin_route('tags.edit',['tag'=>$tag->id])}}"
                                   class="btn"><i class="fas fa-pencil-alt"></i>
                                </a>
                                <form action="{{admin_route('tags.destroy',['tag'=>$tag->id])}}" method="post" class="float-left">
                                    @csrf
                                    @method('DELETE')
